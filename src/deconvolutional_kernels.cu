...
extern "C" void forward_deconvolutional_layer_gpu(deconvolutional_layer layer, network_state state,int n)
{
    ...
    for(i = 0; i < layer.batch; ++i){
        ...
        float *b = layer.bottom_data_gpu + i*layer.c*layer.h*layer.w;
