...
void free_layer(layer l)
{
    ...
    //if(l.bottom_name)        free(l.bottom_name);
    //if(l.top_name)           free(l.top_name);
    if(l.bottom_data)        free(l.bottom_data);
    //if(l.top_data)           free(l.top_data);
    //
    ...
    if(l.weights_gpu_temp)        cuda_free(l.weights_gpu_temp);
    if(l.weights_mean_gpu)        cuda_free(l.weights_mean_gpu);
    if(l.weights_sq_gpu)          cuda_free(l.weights_sq_gpu);
    //coded by linhao for caffe modify
    if(l.bottom_data_gpu)         cuda_free(l.bottom_data_gpu);
    //if(l.top_data_gpu)            cuda_free(l.top_data_gpu);
    // 
